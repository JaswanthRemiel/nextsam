...
export const writings = [
  {
    ...
    description:
      "I’m on the Awwwards Young Jury and I see hundreds of technically perfect but utterly soulless websites. Don’t let yours be one of them.",
  },
  {
    ...
    description:
      "Let me tell you a secret. My journey into the dark, mysterious world of backend development, a land of cryptic commands and humming servers, did not start with a black hoodie and a glowing terminal.",
  },
  {
